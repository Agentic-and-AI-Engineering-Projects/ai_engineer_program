...
- **Agentic Patterns:** Tool-use loops · ReAct · reflection / self-critique (Reflexion) · orchestrator-worker · hub-and-spoke · multi-agent crews · subagent decomposition · arm-routed treatment design
...
- **Evaluation:** Outcome-based two-arm A/B with p-value significance · per-call USD cost tracking from token usage · LLM-as-judge bias awareness (position / verbosity / self-preference / style / drift / preference leakage) · gold-set construction · structured-output grading
...
- **Cross-Functional Partnerships:** Network Engineering · Platform/Cloud SRE · Database Engineering · Storage Engineering · DC Operations · Apple Online Store · Apple Pay · Retail Apps · iCloud · Applied Machine Learning · IT · Security · Finance.
...
Designed and led the development of a commercially successful data backup product, driving technical innovation and product success.
