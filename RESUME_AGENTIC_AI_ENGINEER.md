...
- **Observability & Eval:** LangSmith (@traceable decorator, span hierarchy, trace-URL drill-down from dashboards) · outcome-based A/B with p-value significance testing · per-call USD cost tracking from token usage · LangFuse (in progress)
