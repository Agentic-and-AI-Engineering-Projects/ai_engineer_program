# 06 — Fan-out / Fan-in with Send API

**Status:** placeholder · queued.

## What this pattern is

Parallel workers + reducer-merged aggregator.

LangGraph Send API pattern. Spawn N parallel branches from a single node, aggregate results via a reducer. Used in the P3-Adv orchestrator-worker walkthrough.
